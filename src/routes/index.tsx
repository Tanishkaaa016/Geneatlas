  ...
  head: () => ({
    meta: [
      { title: "GeneAtlas — Cancer subtype classification from RNA-Seq" },
      {
        name: "description",
        content:
          "Explainable deep learning platform that classifies 5 TCGA cancer subtypes from bulk RNA-Seq with SHAP biomarkers and clinical decision support.",
      },
      { property: "og:title", content: "GeneAtlas — Reading cancer in the genome" },
      {
        property: "og:description",
        content:
          "3,268 TCGA samples · 5,000 genes · held-out test metrics · SHAP explainability · clinical decision support.",
      },
    ],
    links: [
